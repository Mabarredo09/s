...
// Add this at the top of your protected pages
...
<div class="profile-container">
    ...
    <div class="profile-content">
        <div class="profile-picture">
            ...
            <form action="update_profile.php" method="post" enctype="multipart/form-data" id="profile-picture-form">
                ...
                <div class="confirm-upload-profile-btn-container">
                    <button type="button" id="cancel-upload-profile-btn" style="display: none;">Cancel</button>
                    <button type="submit" id="upload-profile-btn" disabled style="background-color: #c1c1c1; cursor: not-allowed;">Confirm</button>
                </div>
            </form>
        </div>
